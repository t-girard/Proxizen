...
<body class="bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">Contacts</h2>
                <p class="text-gray-600 dark:text-gray-400">Contacts d'urgence et professionnels de santé</p>
            </div>
            
            <button onclick="openContactModal()" class="px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-medium transition flex items-center gap-2 shadow-lg">
        ...
        <!-- Numéros d'urgence -->
        <div class="mb-8">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">⚠️ Numéros d'urgence</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                
                <!-- SAMU -->
                <button class="card bg-gradient-to-br from-red-500 to-red-600 p-6 rounded-2xl text-white text-left hover:shadow-2xl">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center emergency-pulse">
                    ...
                    <h4 class="font-bold text-lg mb-1">SAMU</h4>
                    <p class="text-sm opacity-90">Urgences médicales</p>
                </button>

                <!-- Pompiers -->
                <button class="card bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-2xl text-white text-left hover:shadow-2xl">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center emergency-pulse">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h4 class="font-bold text-lg mb-1">Pompiers</h4>
                    <p class="text-sm opacity-90">Secours et incendies</p>
                </button>

                <!-- Police -->
                <button class="card bg-gradient-to-br from-blue-600 to-blue-700 p-6 rounded-2xl text-white text-left hover:shadow-2xl">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center emergency-pulse">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h4 class="font-bold text-lg mb-1">Police</h4>
                    <p class="text-sm opacity-90">Secours et sécurité</p>
                </button>
        ...
        <!-- Contacts famille -->
        <div class="mb-8">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">👨‍👩‍👧 Famille</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                
                <!-- Contact 1 -->
                <div class="card bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-800 dark:text-white">Claire Martin</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Sœur • Aidante proche</p>
                        </div>
                    </div>
                    <div class="flex gap-2">
                        <button class="flex-1 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg font-medium transition flex items-center justify-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            Appeler
                        </button>
                        <button class="px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="card bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-14 h-14 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-full flex items-center justify-center text-white text-xl font-bold">
                            TD
                        </div>
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-800 dark:text-white">Thomas Dupont</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Fils</p>
                        </div>
                    </div>
                    <div class="flex gap-2">
                        <button class="flex-1 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg font-medium transition flex items-center justify-center gap-2">
        ...
        <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">🩺 Professionnels de santé</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="card bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-800 dark:text-white">Sophie Dupont</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Infirmière</p>
                        </div>
                    </div>
                    <div class="flex gap-2">
                        <button class="flex-1 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-medium transition flex items-center justify-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            06 12 34 56 78
                ...
                <div class="card bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-800 dark:text-white">Dr. Paul Rousseau</h4>
                ...
                <div class="card bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-800 dark:text-white">Marc Martin</h4>
                ...
                <div class="card bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-800 dark:text-white">Laura Dubois</h4>
    ...
    <!-- Modal ajout contact -->
    <div id="contact-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-2xl font-bold text-gray-800 dark:text-white">Ajouter un contact</h3>
                <button onclick="closeContactModal()" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <form class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Relation</label>
                ...
                <div class="flex gap-3 pt-4">
                    <button type="button" onclick="closeContactModal()" class="flex-1 px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium transition">
                        Annuler
                    </button>
