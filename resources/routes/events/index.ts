...
* @see app/Http/Controllers/EventController.php:24
* @route '/events'
*/
...
* @see app/Http/Controllers/EventController.php:39
* @route '/events'
*/
...
* @see app/Http/Controllers/EventController.php:52
...
* @see app/Http/Controllers/EventController.php:68
* @route '/events/{event}'
*/
