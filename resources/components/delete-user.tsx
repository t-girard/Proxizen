    ...
    return (
        <div className="space-y-6">
            <HeadingSmall
                ...
                description="Supprimez votre compte et toutes les ressources associées"
            />
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            Une fois votre compte supprimé, toutes les ressources
                            et données associées seront définitivement supprimées.
                            Veuillez saisir votre mot de passe pour confirmer la
